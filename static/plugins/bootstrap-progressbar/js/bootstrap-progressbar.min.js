...
(function (a) {
    ...
    h.prototype = {
        constructor: h, transition: function () {
            var d = this.element, e = d.parent(), f = this.back, g = this.front, c = this.options, j = d.attr("data-percentage"), h = d.attr("data-amount-part"), k = d.attr("data-amount-total"), l, p, q, i;
            ...
            if (c.use_percentage && !j)i("bootstrap-progressbar: you can't use percentage without data-percentage being set"); else {
                if (!c.use_percentage) {
                    if (!h && !k) {
    ...
    a.fn.progressbar = function (d) {
        return this.each(function () {
            var e = a(this), f = e.data("progressbar"), g = "object" === typeof d && d;
            f || e.data("progressbar", f = new h(this, g));
            if ("string" === typeof d)f[d]();
            f.transition()
        })
    };
    a.fn.progressbar.display_text = {none: 0, filled: 1, center: 2};
