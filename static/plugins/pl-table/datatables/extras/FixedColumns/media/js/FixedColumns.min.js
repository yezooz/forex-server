...
(function (b, q) {
    FixedColumns = function (a, e) {
        !this instanceof FixedColumns ? alert("FixedColumns warning: FixedColumns must be initialised with the 'new' keyword.") : ("undefined" == typeof e && (e = {}), this.s = {
            dt: a.fnSettings(),
            iTableColumns: a.fnSettings().aoColumns.length,
            aiWidths: [],
            bOldIE: b.browser.msie && ("6.0" == b.browser.version || "7.0" == b.browser.version)
        }, this.dom = {
        ...
        fnUpdate: function () {
            ...
            for (var c = [], f = [], g = [], d = 0, h = a.length; d < h; d++) {
                ...
                for (var k = 0, m = this.s.iTableColumns; k < m; k++)if (-1 !== b.inArray(k, e)) {
                    ...
                    -1 === j ? (j = b(a[d][k].cell).clone(!0)[0], f.push(j), g.push(a[d][k].cell), i.push({
                        cell: j,
                        unique: a[d][k].unique
                    })) :
