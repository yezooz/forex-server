...
!function (b) {
    ...
    a.prototype.checkPosition = function () {
        ...
        var i = b(document).height(), c = this.$window.scrollTop(), d = this.$element.offset(), j = this.options.offset, h = j.bottom, f = j.top, e = "affix affix-top affix-bottom", g;
        if (typeof j != "object") {
            h = f = j
        }
        ...
        g = this.unpin != null && (c + this.unpin <= d.top) ? false : h != null && (d.top + this.$element.height() >= i - h) ? "bottom" : f != null && c <= f ? "top" : false;
        if (this.affixed === g) {
            return
        }
        this.affixed = g;
        this.unpin = g == "bottom" ? d.top - c : null;
        this.$element.removeClass(e).addClass("affix" + (g ? "-" + g : ""))
    };
    b.fn.affix = function (c) {
        return this.each(function () {
            var e = b(this), f = e.data("affix"), d = typeof c == "object" && c;
            if (!f) {
                e.data("affix", (f = new a(this, d)))
            }
            if (typeof c == "string") {
                f[c]()
            }
...
!function (c) {
    var a = '[data-dismiss="alert"]', b = function (d) {
        c(d).on("click", a, this.close)
    };
    b.prototype.close = function (g) {
        var h = c(this), d = h.attr("data-target"), i;
        if (!d) {
            d = h.attr("href");
            d = d && d.replace(/.*(?=#[^\s]*$)/, "")
        }
        i = c(d);
        g && g.preventDefault();
        i.length || (i = h.hasClass("alert") ? h : h.parent());
        i.trigger(g = c.Event("close"));
        ...
        c.support.transition && i.hasClass("fade") ? i.on(c.support.transition.end, f) : f()
    };
    c.fn.alert = function (d) {
        return this.each(function () {
            var e = c(this), f = e.data("alert");
            if (!f) {
                e.data("alert", (f = new b(this)))
            }
            if (typeof d == "string") {
                f[d].call(e)
            }
    ...
    c.fn.alert.Constructor = b;
    c(document).on("click.alert.data-api", a, b.prototype.close)
}(window.jQuery);
!function (b) {
    var a = function (c, d) {
        this.$element = b(c);
        this.options = b.extend({}, b.fn.button.defaults, d)
    };
    a.prototype.setState = function (c) {
        var f = "disabled", e = this.$element, h = e.data(), g = e.is("input") ? "val" : "html";
        c = c + "Text";
        h.resetText || e.data("resetText", e[g]());
        e[g](h[c] || this.options[c]);
        setTimeout(function () {
            c == "loadingText" ? e.addClass(f).attr(f, f) : e.removeClass(f).removeAttr(f)
        }, 0)
    };
    ...
    b.fn.button = function (c) {
        return this.each(function () {
            var e = b(this), f = e.data("button"), d = typeof c == "object" && c;
            if (!f) {
                e.data("button", (f = new a(this, d)))
            }
            if (c == "toggle") {
                f.toggle()
            } else {
...
!function (b) {
    ...
    a.prototype = {
        cycle: function (c) {
            ...
            var e = this.$element.find(".item.active"), d = e.parent().children(), g = d.index(e), c = this;
            if (f > (d.length - 1) || f < 0) {
                return
            }
            if (this.sliding) {
            ...
            return this.slide(f > g ? "next" : "prev", b(d[f]))
        }, pause: function (c) {
            if (!c) {
                this.paused = true
            }
            ...
            var i = this.$element.find(".item.active"), g = d || i[h](), k = this.interval, l = h == "next" ? "left" : "right", c = h == "next" ? "first" : "last", f = this, j;
            this.sliding = true;
            k && this.pause();
            g = g.length ? g : this.$element.find(".item")[c]();
            j = b.Event("slide", {relatedTarget: g[0]});
            ...
            if (b.support.transition && this.$element.hasClass("slide")) {
                ...
                this.$element.one(b.support.transition.end, function () {
                    g.removeClass([h, l].join(" ")).addClass("active");
    ...
    b.fn.carousel = function (c) {
        return this.each(function () {
            var f = b(this), g = f.data("carousel"), e = b.extend({}, b.fn.carousel.defaults, typeof c == "object" && c), d = typeof c == "string" ? c : e.slide;
            if (!g) {
                f.data("carousel", (g = new a(this, e)))
            }
            if (typeof c == "number") {
                g.to(c)
            } else {
    ...
    b(document).on("click.carousel.data-api", "[data-slide]", function (g) {
        var h = b(this), c, d = b(h.attr("data-target") || (c = h.attr("href")) && c.replace(/.*(?=#[^\s]+$)/, "")), f = b.extend({}, d.data(), h.data());
        d.carousel(f);
        g.preventDefault()
    })
}(window.jQuery);
!function (a) {
    var b = function (c, d) {
        this.$element = a(c);
        this.options = a.extend({}, a.fn.collapse.defaults, d);
    ...
    b.prototype = {
        constructor: b, dimension: function () {
            ...
            a.support.transition && this.$element[c](this.$element[0][d])
        }, hide: function () {
            var c;
            if (this.transitioning) {
                return
    ...
    a.fn.collapse = function (c) {
        return this.each(function () {
            var e = a(this), f = e.data("collapse"), d = typeof c == "object" && c;
            if (!f) {
                e.data("collapse", (f = new b(this, d)))
            }
            if (typeof c == "string") {
                f[c]()
            }
    ...
    a(document).on("click.collapse.data-api", "[data-toggle=collapse]", function (g) {
        var h = a(this), c, d = h.attr("data-target") || g.preventDefault() || (c = h.attr("href")) && c.replace(/.*(?=#[^\s]+$)/, ""), f = a(d).data("collapse") ? "toggle" : h.data();
        h[a(d).hasClass("in") ? "addClass" : "removeClass"]("collapsed");
        a(d).collapse(f)
    })
}(window.jQuery);
!function (e) {
    var b = "[data-toggle=dropdown]", d = function (g) {
    ...
    d.prototype = {
        constructor: d, toggle: function (g) {
            var h = e(this), i, f;
            ...
            h = e("[role=menu] li:not(.divider) a", l);
            if (!h.length) {
                return
            }
            f = h.index(h.filter(":focus"));
            if (j.keyCode == 38 && f > 0) {
                f--
            }
            if (j.keyCode == 40 && f < h.length - 1) {
                f++
            }
            if (!~f) {
                f = 0
    ...
    function c() {
        e(b).each(function () {
            a(e(this)).removeClass("open")
        })
    }

    function a(g) {
        var f = g.attr("data-target"), h;
        if (!f) {
            f = g.attr("href");
    ...
    e.fn.dropdown = function (f) {
        return this.each(function () {
            var g = e(this), h = g.data("dropdown");
            if (!h) {
                g.data("dropdown", (h = new d(this)))
            }
            if (typeof f == "string") {
                h[f].call(g)
            }
    ...
    e(document).on("click.dropdown.data-api touchstart.dropdown.data-api", c).on("click.dropdown touchstart.dropdown.data-api", ".dropdown form", function (f) {
        f.stopPropagation()
    }).on("click.dropdown.data-api touchstart.dropdown.data-api", b, d.prototype.toggle).on("keydown.dropdown.data-api touchstart.dropdown.data-api", b + ", [role=menu]", d.prototype.keydown)
}(window.jQuery);
!function (b) {
    var a = function (c, d) {
        this.options = d;
    ...
    a.prototype = {
        constructor: a, toggle: function () {
            ...
            if (this.isShown && this.options.backdrop) {
                ...
                e ? this.$backdrop.one(b.support.transition.end, f) : f()
            } else {
    ...
    b.fn.modal = function (c) {
        return this.each(function () {
            var e = b(this), f = e.data("modal"), d = b.extend({}, b.fn.modal.defaults, e.data(), typeof c == "object" && c);
            if (!f) {
                e.data("modal", (f = new a(this, d)))
            }
            if (typeof c == "string") {
                f[c]()
            } else {
    ...
    b(document).on("click.modal.data-api", '[data-toggle="modal"]', function (g) {
        var h = b(this), c = h.attr("href"), d = b(h.attr("data-target") || (c && c.replace(/.*(?=#[^\s]+$)/, ""))), f = d.data("modal") ? "toggle" : b.extend({remote: !/#/.test(c) && c}, d.data(), h.data());
        g.preventDefault();
...
!function (a) {
    ...
    b.prototype = a.extend({}, a.fn.tooltip.Constructor.prototype, {
        constructor: b, setContent: function () {
            var e = this.tip(), c = this.getTitle(), d = this.getContent();
            e.find(".popover-title")[this.options.html ? "html" : "text"](c);
            e.find(".popover-content > *")[this.options.html ? "html" : "text"](d);
            e.removeClass("fade top bottom left right in")
        }, hasContent: function () {
            return this.getTitle() || this.getContent()
        }, getContent: function () {
            var c, d = this.$element, e = this.options;
            c = d.attr("data-content") || (typeof e.content == "function" ? e.content.call(d[0]) : e.content);
            return c
        }, tip: function () {
            if (!this.$tip) {
    ...
    a.fn.popover = function (c) {
        return this.each(function () {
            var e = a(this), f = e.data("popover"), d = typeof c == "object" && c;
            if (!f) {
                e.data("popover", (f = new b(this, d)))
            }
            if (typeof c == "string") {
                f[c]()
            }
...
!function (a) {
    function b(f, g) {
        var e = a.proxy(this.process, this), d = a(f).is("body") ? a(window) : a(f), c;
        this.options = a.extend({}, a.fn.scrollspy.defaults, g);
        this.$scrollElement = d.on("scroll.scroll-spy.data-api", e);
        this.selector = (this.options.target || ((c = a(f).attr("href")) && c.replace(/.*(?=#[^\s]+$)/, "")) || "") + " .nav li > a";
        this.$body = a("body");
        this.refresh();
        this.process()
    }
    ...
    b.prototype = {
        constructor: b, refresh: function () {
            ...
            d = this.$body.find(this.selector).map(function () {
                var e = a(this), f = e.data("target") || e.attr("href"), g = /^#\w/.test(f) && a(f);
                return (g && g.length && [[g.position().top, f]]) || null
            }).sort(function (e, f) {
                return e[0] - f[0]
            }).each(function () {
            ...
            var h = this.$scrollElement.scrollTop() + this.options.offset, e = this.$scrollElement[0].scrollHeight || this.$body[0].scrollHeight, g = e - this.$scrollElement.height(), j = this.offsets, c = this.targets, f = this.activeTarget, d;
            if (h >= g) {
                return f != (d = c.last()[0]) && this.activate(d)
            }
            for (d = j.length; d--;) {
                f != c[d] && h >= j[d] && (!j[d + 1] || h <= j[d + 1]) && this.activate(c[d])
            }
        }, activate: function (c) {
            var e, d;
            this.activeTarget = c;
            ...
            e = a(d).parent("li").addClass("active");
    ...
    a.fn.scrollspy = function (c) {
        return this.each(function () {
            var e = a(this), f = e.data("scrollspy"), d = typeof c == "object" && c;
            if (!f) {
                e.data("scrollspy", (f = new b(this, d)))
            }
            if (typeof c == "string") {
                f[c]()
            }
...
!function (b) {
    ...
    a.prototype = {
        constructor: a, show: function () {
            var i = this.element, c = i.closest("ul:not(.dropdown-menu)"), g = i.attr("data-target"), f, d, h;
            if (!g) {
                g = i.attr("href");
                g = g && g.replace(/.*(?=#[^\s]*$)/, "")
            }
            ...
            f = c.find(".active:last a")[0];
            h = b.Event("show", {relatedTarget: f});
            i.trigger(h);
            if (h.isDefaultPrevented()) {
                return
            }
            d = b(g);
            this.activate(i.parent("li"), c);
            this.activate(d, d.parent(), function () {
                i.trigger({type: "shown", relatedTarget: f})
            })
        }, activate: function (f, d, h) {
            var e = d.find("> .active"), c = h && b.support.transition && e.hasClass("fade");
            ...
            c ? e.one(b.support.transition.end, g) : g();
            e.removeClass("in")
        }
    };
    b.fn.tab = function (c) {
        return this.each(function () {
            var d = b(this), e = d.data("tab");
            if (!e) {
                d.data("tab", (e = new a(this)))
            }
            if (typeof c == "string") {
                e[c]()
            }
...
!function (b) {
    ...
    a.prototype = {
        constructor: a, select: function () {
            ...
            var c = [], g = [], f = [], d;
            while (d = e.shift()) {
                if (!d.toLowerCase().indexOf(this.query.toLowerCase())) {
                    c.push(d)
                } else {
                    if (~d.indexOf(this.query)) {
                        g.push(d)
                    } else {
                        f.push(d)
                    }
            ...
            return d.replace(new RegExp("(" + c + ")", "ig"), function (f, e) {
                return "<strong>" + e + "</strong>"
            })
        }, render: function (d) {
            var c = this;
            d = b(d).map(function (e, f) {
                e = b(c.options.item).attr("data-value", f);
    ...
    b.fn.typeahead = function (c) {
        return this.each(function () {
            var e = b(this), f = e.data("typeahead"), d = typeof c == "object" && c;
            if (!f) {
                e.data("typeahead", (f = new a(this, d)))
            }
            if (typeof c == "string") {
                f[c]()
            }
...
!function (b) {
    ...
    a.prototype = {
        constructor: a, init: function (d, e, f) {
            var g, c;
            this.type = d;
            this.$element = b(e);
            ...
            if (this.hasContent() && this.enabled) {
                ...
                g = typeof this.options.placement == "function" ? this.options.placement.call(this, h[0], this.$element[0]) : this.options.placement;
                e = /in/.test(g);
                h.detach().css({top: 0, left: 0, display: "block"}).insertAfter(this.$element);
                f = this.getPosition(e);
                i = h[0].offsetWidth;
                c = h[0].offsetHeight;
                switch (e ? g.split(" ")[1] : g) {
                    case"bottom":
                        d = {top: f.top + f.height, left: f.left + f.width / 2 - i / 2};
                        break;
                    case"top":
                        d = {top: f.top - c, left: f.left + f.width / 2 - i / 2};
                        break;
                    case"left":
                        d = {top: f.top + f.height / 2 - c / 2, left: f.left - i};
                        break;
                    case"right":
                        d = {top: f.top + f.height / 2 - c / 2, left: f.left + f.width};
                        break
                }
                h.offset(d).addClass(g).addClass("in")
            }
        }, setContent: function () {
            ...
            b.support.transition && this.$tip.hasClass("fade") ? d() : e.detach();
            return this
        }, fixTitle: function () {
            var c = this.$element;
            ...
            return b.extend({}, (c ? {top: 0, left: 0} : this.$element.offset()), {
                width: this.$element[0].offsetWidth,
                height: this.$element[0].offsetHeight
            })
        }, getTitle: function () {
            var c, d = this.$element, e = this.options;
            c = d.attr("data-original-title") || (typeof e.title == "function" ? e.title.call(d[0]) : e.title);
            return c
        }, tip: function () {
    ...
    b.fn.tooltip = function (c) {
        return this.each(function () {
            var e = b(this), f = e.data("tooltip"), d = typeof c == "object" && c;
            if (!f) {
                e.data("tooltip", (f = new a(this, d)))
            }
            if (typeof c == "string") {
                f[c]()
            }
...
!function (a) {
    a(function () {
        a.support.transition = (function () {
            var b = (function () {
                var d = document.createElement("bootstrap"), e = {
