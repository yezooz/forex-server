...
$(function () {
    ...
    $('#ajaxModal').on('click', function () {
        ...
        setTimeout(function () {
            $modal.load('/static/data/modal_ajax_test.html', '', function () {
                $modal.modal();
            });
        }, 1000);
    })
        ...
        bootbox.confirm("This confirm has custom buttons - see?", "No", "Yes!", function (result) {
            if (result) {
                ...
                $.gritter.add({
                    ...
                    image: '/static/img/demo/demo-avatar9604.jpg',
                    sticky: false,
                    time: 3000,
                    class_name: 'gritter-light'
                });
                ...
                $.gritter.add({
                    title: 'Oh no!',
                    text: 'try again!',
                    image: '/static/img/demo/_demo-avatar9604.jpg',
                    sticky: false,
                    time: 3000
                });
            }
